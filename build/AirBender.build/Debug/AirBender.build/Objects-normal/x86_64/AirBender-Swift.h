...
#ifndef AIRBENDER_SWIFT_H
#define AIRBENDER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AirBender",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSCoder;
SWIFT_CLASS("_TtC9AirBender10FanInfoDTO")
...
@class NSNumber;
@class NSString;
SWIFT_PROTOCOL("_TtP9AirBender14HelperProtocol_")
